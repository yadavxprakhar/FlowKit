...
import { Target, Heart, Zap, Shield, Users, Rocket, Sparkles } from 'lucide-react';
...
const AboutPage = () => {
  const values = [
    ...
    { title: "Built for Flow", description: "Every interaction is designed to minimize context switching and keep your team in a state of deep work.", icon: Target, color: "text-blue-500", bg: "bg-blue-500/10" },
    { title: "Radical Transparency", description: "No hidden pricing, no dark patterns. We build trust by being open about our roadmap and decisions.", icon: Shield, color: "text-emerald-500", bg: "bg-emerald-500/10" },
      ...
      <main className="relative pt-40 pb-24 px-6">
        ...
        <section className="max-w-4xl mx-auto text-center mb-32">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-md mb-8">
            ...
            <span className="text-xs font-bold tracking-widest uppercase text-blue-400">Our Mission</span>
          </div>
          <h1 className="text-5xl md:text-7xl font-black text-white mb-8 tracking-tight">
            We are building the <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400">future of focus.</span>
          </h1>
        ...
        <section className="max-w-6xl mx-auto mb-40">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 items-center">
            <div className="relative group">
              <div className="absolute -inset-4 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-[40px] blur-2xl opacity-50 group-hover:opacity-100 transition-opacity"></div>
              <div className="relative h-[450px] rounded-[32px] bg-[#0f172a] border border-white/10 overflow-hidden shadow-2xl flex items-center justify-center">
            ...
            <div className="space-y-8">
              ...
              <div className="pt-6">
                <div className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/5 backdrop-blur-xl">
                  <div className="w-12 h-12 rounded-xl bg-blue-600 flex items-center justify-center text-white font-bold">P</div>
                  <div>
        ...
        {/* Final CTA */}
        <section className="mt-40 text-center relative overflow-hidden rounded-[48px] bg-gradient-to-br from-indigo-900/40 to-blue-900/40 border border-white/10 p-20 backdrop-blur-xl">
          ...
          <p className="text-lg text-slate-400 mb-10 max-w-xl mx-auto">We're always looking for brilliant minds to help us redefine productivity.</p>
          <button className="px-10 py-4 bg-white text-[#020617] rounded-2xl font-black transition-all hover:scale-105 active:scale-95 shadow-2xl">
            See Open Roles
          </button>
        </section>
      </main>
