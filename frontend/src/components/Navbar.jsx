    ...
    <nav className="fixed top-6 left-1/2 -translate-x-1/2 w-[90%] max-w-6xl z-50">
      <div className="bg-white/5 backdrop-blur-2xl border border-white/10 rounded-[32px] px-8 py-4 flex justify-between items-center shadow-2xl">
        ...
        <div className="hidden md:flex gap-10 items-center">
          ...
          {isLoggedIn && (
            <Link to="/dashboard" className="text-sm font-bold text-[#20B2AA] hover:text-[#7CC0D8] transition-colors flex items-center gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-[#20B2AA] animate-pulse"></span>
              Dashboard
            </Link>
          )}
          <Link to="/pricing" className="text-sm font-bold text-[#D7CCC8] hover:text-white transition-colors">Pricing</Link>
