...
const SecurityPage = () => {
  return (
    <LegalPageLayout title="Security Information" lastUpdated="May 13, 2026">
      <h2 className="text-2xl font-bold text-text-primary-light dark:text-text-primary-dark mt-8 mb-4">1. Data Encryption</h2>
      <p>
      ...
      <h2 className="text-2xl font-bold text-text-primary-light dark:text-text-primary-dark mt-8 mb-4">2. Infrastructure Security</h2>
      <p>
      ...
      <h2 className="text-2xl font-bold text-text-primary-light dark:text-text-primary-dark mt-8 mb-4">3. Authentication & Access</h2>
      <p>
      ...
      <h2 className="text-2xl font-bold text-text-primary-light dark:text-text-primary-dark mt-8 mb-4">4. Vulnerability Reporting</h2>
      <p>
